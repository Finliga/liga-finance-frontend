...
export default function ServicesList({ servicesList }: ServicesListProps) {
  return (
    <AnimatedListItem className="flex flex-col items-center w-[90%] max-w-[340px] tabxl:max-w-[380px] xl:max-w-[430px] min-h-[336px] xl:min-h-[492px] p-7 xl:p-[44px] mx-auto tabxl:mx-0 bg-white rounded-[8px]">
